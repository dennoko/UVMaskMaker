...
namespace Dennoko.UVTools
{
    ...
    internal static class MaskMakerVersion
    {
        ...
        internal const string VerCheckLastAttemptKey  = "MaskMaker_VerCheck_LastAttemptUtc";
        internal const string VerCheckCachedLatestKey = "MaskMaker_VerCheck_CachedLatest";
        internal const string VerCheckCachedUrlKey    = "MaskMaker_VerCheck_CachedUrl";
        internal const string VerCheckCachedMessageKey = "MaskMaker_VerCheck_CachedMessage";
